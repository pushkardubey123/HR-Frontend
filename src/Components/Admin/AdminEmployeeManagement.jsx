...
const EmployeeManagement = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      if (editId) {
        await axios.put(
          `${import.meta.env.VITE_API_URL}/employeeget/${editId}`,
          data,
          getHeaders()
        );
      ...
      html: `
        <div style="text-align:left; max-height:500px; overflow-y:auto">
          ...
          <table class='table table-bordered'>
            ...
            <tr><td><b>Emergency Contact</b></td><td>${
    ...
    <AdminLayout>
      <div className="employee-container px-2">
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
          <h4 className="section-heading d-flex align-items-center gap-2">
        ...
        <Modal.Body>
          ...
          >
            ...
            <div>
              ...
              />
              <p className="text-danger small">{errors.pan?.message}</p>
            </div>
            <div>
              <input
              ...
              />
              <p className="text-danger small">{errors.bankAccount?.message}</p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-danger small">{errors.doj?.message}</p>
            </div>
            {!editId && (
              <div>
                <input
