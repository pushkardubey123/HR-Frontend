...
const Login = ({ onClose, onLoginSuccess }) => {
  ...
  const showAlert = (title, text, icon) => {
    Swal.fire({ title, text, icon, customClass: { container: "custom-swal-zindex" } });
  };
      ...
      <div className="card shadow" style={modalStyle}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="card-footer flex justify-around mt-3">
            <p>Not registered? <Link to="/register" onClick={onClose}>Signup</Link></p>
...
const backdropStyle = { position: "fixed", top: 0, left: 0, width: "100vw", height: "100vh", backgroundColor: "rgba(0, 0, 0, 0.5)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 9999 };
